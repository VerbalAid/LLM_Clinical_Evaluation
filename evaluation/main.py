...
# Public repo: synthetic demo file. Internal HiTZ work: set env CC_MIR_CORPUS_FILE to your JSON.
CORPUS_FILE = os.environ.get("CC_MIR_CORPUS_FILE", "demo_case_for_public_repo.json")

MODEL_NAME = "medllama2:7b"

# Prompt selection (relative to this package directory)
ARG_PROMPT_FILE = os.path.join("prompts", "Prompt1", "argument_prompt.txt")
